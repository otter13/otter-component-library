...
const IconRedirectMailOutlined = (props) => (
  <svg width="1em" height="1em" viewBox="0 0 26 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export default withIcon(IconRedirectMailOutlined);
